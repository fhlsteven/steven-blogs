import{_ as t,r as p,o,c as e,b as n,d as s,e as c,a as l}from"./app-a2b6e588.js";const u={},k=l(`<h1 id="创建具有自验证功能的textbox控件" tabindex="-1"><a class="header-anchor" href="#创建具有自验证功能的textbox控件" aria-hidden="true">#</a> 创建具有自验证功能的textbox控件</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>kwklover（翻译）
关键字  textbox,控件开发,验证
