import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="一个不规则窗口界面的示例-原创" tabindex="-1"><a class="header-anchor" href="#一个不规则窗口界面的示例-原创" aria-hidden="true">#</a> 一个不规则窗口界面的示例（原创）</h1><blockquote><p>www.wenhui.org 10/23/2002 CSharp vs Java</p></blockquote><p>椭圆开窗体</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
