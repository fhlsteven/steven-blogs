import{_ as n,o as s,c as a,a as t}from"./app-8e5157a8.js";const p={},o=t(`<h1 id="c-中的日期数据类型的使用" tabindex="-1"><a class="header-anchor" href="#c-中的日期数据类型的使用" aria-hidden="true">#</a> C#中的日期数据类型的使用</h1><p>痕迹 程序员大联盟 2003-4-9</p><p>详细代码请参看：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
