import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="使用c-返回系统特殊路径" tabindex="-1"><a class="header-anchor" href="#使用c-返回系统特殊路径" aria-hidden="true">#</a> 使用C#返回系统特殊路径</h1><blockquote><p>你是第114位浏览该文章的人 menway csdn 2003-5-22</p></blockquote><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
