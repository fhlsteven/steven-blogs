import{_ as r,r as d,o as i,c as o,b as t,d as n,e as s,a}from"./app-d9da1b6d.js";const l={},c=t("h1",{id:"面试题-01-02-判定是否互为字符重排",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#面试题-01-02-判定是否互为字符重排","aria-hidden":"true"},"#"),n(" 面试题 01.02. 判定是否互为字符重排")],-1),h={id:"_01-02-判定是否互为字符重排-简单",tabindex:"-1"},u=t("a",{class:"header-anchor",href:"#_01-02-判定是否互为字符重排-简单","aria-hidden":"true"},"#",-1),g={href:"https://leetcode-cn.com/problems/check-permutation-lcci/",target:"_blank",rel:"noopener noreferrer"},f=t("strong",null,"简单",-1),p=a(`<p>给定两个字符串 <code>s1</code> 和 <code>s2</code>，请编写一个程序，确定其中一个字符串的字符重新排列后，能否变成另一个字符串。</p><p>示例 1：</p><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>输入: s1 = &quot;abc&quot;, s2 = &quot;bca&quot;
输出: true 
