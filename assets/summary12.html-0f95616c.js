import{_ as n,o as s,c as a,a as t}from"./app-a2b6e588.js";const p={},o=t(`<h1 id="net中的exception处理-c" tabindex="-1"><a class="header-anchor" href="#net中的exception处理-c" aria-hidden="true">#</a> NET中的Exception处理(C#)</h1><h2 id="摘要" tabindex="-1"><a class="header-anchor" href="#摘要" aria-hidden="true">#</a> 摘要</h2><p>本文以C#为编程语言，讨论了 .NET 中的异常处理方式，主要包括 try/catch 块、finally语句、Exception 对象、throw语句等主题。</p><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>本文内容
理解异常的基本概念
使用 try/catch 块处理异常
理解finally的意义
使用 Exception 对象确定异常
