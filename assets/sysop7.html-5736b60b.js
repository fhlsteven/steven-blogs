import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p="/steven-blogs/assets/sysop7_1-04841c95.png",o={},c=t(`<h1 id="一个监测iis-并定时重新启动的程序" tabindex="-1"><a class="header-anchor" href="#一个监测iis-并定时重新启动的程序" aria-hidden="true">#</a> 一个监测IIS，并定时重新启动的程序</h1><p>前言：我的Win2003 Server的IIS执行Asp老是不正常，长的时候可以用几天，短的时候才几个小时就动不动就超时，被客户骂得半死了。没办法所以写了个服务来检查。这是下策。</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
