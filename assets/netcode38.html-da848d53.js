import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="用浏览器来接收c-的程序返回的时间cool" tabindex="-1"><a class="header-anchor" href="#用浏览器来接收c-的程序返回的时间cool" aria-hidden="true">#</a> 用浏览器来接收C# 的程序返回的时间cool</h1><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token comment">/*
豆腐制作 都是精品
