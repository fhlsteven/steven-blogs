import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="取exe或者dll的运行文件所在目录" tabindex="-1"><a class="header-anchor" href="#取exe或者dll的运行文件所在目录" aria-hidden="true">#</a> 取EXE或者DLL的运行文件所在目录</h1><blockquote><p>作者：李侠</p></blockquote><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
