import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="用c-实现生成pdf文档-原码" tabindex="-1"><a class="header-anchor" href="#用c-实现生成pdf文档-原码" aria-hidden="true">#</a> 用C#实现生成PDF文档（原码）</h1><blockquote><p>未知 www.wenhui.org 2002-11-17</p></blockquote><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token comment">//write by wenhui.org</span>
