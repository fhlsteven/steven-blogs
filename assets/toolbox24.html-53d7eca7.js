import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="在-visual-c-net-中建立一个平滑的进度条" tabindex="-1"><a class="header-anchor" href="#在-visual-c-net-中建立一个平滑的进度条" aria-hidden="true">#</a> 在 Visual C# .NET 中建立一个平滑的进度条</h1><p>本文讨论的内容属于：<br> 微软 Visual Basic .NET(2002)<br> 如果您想要参考 Microsoft Visual Basic .NET 版本的文章，请参考Q323088。</p><h2 id="本文内容" tabindex="-1"><a class="header-anchor" href="#本文内容" aria-hidden="true">#</a> 本文内容</h2><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>概述
建立一个自定义的进度条控件
建立一个简单的客户端应用
