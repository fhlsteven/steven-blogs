import{_ as n,o as s,c as a,a as p}from"./app-d9da1b6d.js";const t={},o=p(`<h1 id="由文件名获取文件图标-原码" tabindex="-1"><a class="header-anchor" href="#由文件名获取文件图标-原码" aria-hidden="true">#</a> 由文件名获取文件图标（原码）</h1><blockquote><p>作者：痕迹</p></blockquote><p>核心代码：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
