import{_ as n,o as s,c as a,d as t}from"./app-3696c600.js";const p={},o=t(`<h1 id="通过事件-在两窗体间传递数据" tabindex="-1"><a class="header-anchor" href="#通过事件-在两窗体间传递数据" aria-hidden="true">#</a> 通过事件，在两窗体间传递数据</h1><p>www.chinacs.net 2002-5-9 中文C#技术站</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token comment">//---------------------------------------</span>
