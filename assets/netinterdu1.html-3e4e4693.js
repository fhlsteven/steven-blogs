import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="下载网页数据-zj" tabindex="-1"><a class="header-anchor" href="#下载网页数据-zj" aria-hidden="true">#</a> 下载网页数据_zj</h1><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System<span class="token punctuation">.</span>Net</span><span class="token punctuation">;</span>
