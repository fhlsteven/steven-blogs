import{_ as n,o as s,c as a,a as p}from"./app-f0851ed3.js";const t={},o=p(`<h1 id="关于如何将word文件读入richtextbox" tabindex="-1"><a class="header-anchor" href="#关于如何将word文件读入richtextbox" aria-hidden="true">#</a> 关于如何将word文件读入RichTextBox</h1><p>我在别的论坛经常看到有的朋友们问怎么样将word文件读入到richtextbox,（包括图片）而且要求如要修改后能保存，我想的一个办法：使用剪贴板的办法。我做了一个类，可以用于我们以后开发WORD的程序：</p><p>1、在运行这个程序之前请先导入三个dll　 它们是：Interop.Microsoft.Office.Core.dll、Interop.VBIDE.dll、Interop.Word.dll）它们如何得到请查看一下以前的贴子，有很多是讲如何将com组件转为受限代码的。如果实现找不到也可以和我联系，我发给你！<code>huanghai@bdfsz.com.cn</code></p><p>2、其实我们可以这样控制word ,在启动word后选录制新宏，开始我们的动作，比如我们想看一下用VBA如何控制全选－复制－剪切，就可以用这个办法。停止录制。用VBA编辑器看一下代码吧！</p><p>3 、废话不说了，看我的程序吧！</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
