import{_ as a,o as s,c as n,a as p}from"./app-57d1f7b1.js";const t={},e=p(`<h1 id="c-程序编码规范" tabindex="-1"><a class="header-anchor" href="#c-程序编码规范" aria-hidden="true">#</a> C#程序编码规范</h1><h2 id="_1-目的" tabindex="-1"><a class="header-anchor" href="#_1-目的" aria-hidden="true">#</a> 1.目的</h2><p>为了保证企业编写出的程序都符合相同的规范，保证一致性、统一性而建立的程序编码规范。</p><h2 id="_2-范围" tabindex="-1"><a class="header-anchor" href="#_2-范围" aria-hidden="true">#</a> 2.范围</h2><p>适用于企业所有基于.NET平台的软件开发工作。</p><h2 id="_3-规范内容" tabindex="-1"><a class="header-anchor" href="#_3-规范内容" aria-hidden="true">#</a> 3.规范内容</h2><h3 id="_3-1-代码格式" tabindex="-1"><a class="header-anchor" href="#_3-1-代码格式" aria-hidden="true">#</a> 3.1.代码格式</h3><p>1.所有的缩进为4个空格，使用VS.NET的默认设置。</p><p>2.在代码中垂直对齐左括号和右括号。</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">if</span><span class="token punctuation">(</span>x<span class="token operator">==</span><span class="token number">0</span><span class="token punctuation">)</span>
