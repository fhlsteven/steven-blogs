import{_ as a,r as l,o as i,c as s,b as t,d as n,e as o,a as r}from"./app-a2b6e588.js";const c={},u=t("h1",{id:"面试题-01-01-判定字符是否唯一",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#面试题-01-01-判定字符是否唯一","aria-hidden":"true"},"#"),n(" 面试题 01.01. 判定字符是否唯一")],-1),d={id:"题目-面试题-01-01-判定字符是否唯一",tabindex:"-1"},g=t("a",{class:"header-anchor",href:"#题目-面试题-01-01-判定字符是否唯一","aria-hidden":"true"},"#",-1),p={href:"https://leetcode-cn.com/problems/is-unique-lcci/",target:"_blank",rel:"noopener noreferrer"},h={href:"https://leetcode-cn.com/problems/is-unique-lcci/",target:"_blank",rel:"noopener noreferrer"},q=t("strong",null,"简单",-1),C=r(`<p>要求：实现一个算法，确定一个字符串 s 的所有字符是否全都不同。</p><p>示例 1：</p><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>输入: s = &quot;leetcode&quot;
输出: false 
...
</code></pre></div><h2 id="反思" tabindex="-1"><a class="header-anchor" href="#反思" aria-hidden="true">#</a> 反思</h2><p>看了答案之后，才明白这道题真正考察的是位运算，这块是自己一个模糊概念。</p><ol><li>计算机处理的都是 0 1 0 1</li><li>编程语言处理数据也都是基于0101的，都是各自有规定。</li></ol><p>不太会组织，大概意思就是想说 计算机底层都是处理0101的，C#的值类型都是0101 看是多少位归于那种类型</p>`,19),_={href:"https://docs.microsoft.com/zh-cn/dotnet/csharp/language-reference/operators/bitwise-and-shift-operators",target:"_blank",rel:"noopener noreferrer"},v=t("code",null,"<<",-1),f=r(`<div class="language-C#" data-ext="C#"><pre class="language-C#"><code>// Convert.ToString(1L,2) 后面2代表 2进制
...
</code></pre></div><p>看完就明白了</p>`,6);function L(x,b){const e=l("ExternalLinkIcon");return i(),s("div",null,[u,t("h2",d,[g,n(" 题目："),t("a",p,[n("面试题 01.01. 判定字符是否唯一"),o(e)])]),t("p",null,[t("a",h,[n("原题链接"),o(e)]),n(","),q,n("。")]),C,t("p",null,[t("a",_,[n("位运算符和移位运算符（C# 参考）"),o(e)]),n(" 先的明白"),v,n("左移运算，如下，一看便知")]),f])}const m=a(c,[["render",L],["__file","0101判读字符是否唯一.html.vue"]]);export{m as default};
