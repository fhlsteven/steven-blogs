import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="实现键盘和鼠标的模拟" tabindex="-1"><a class="header-anchor" href="#实现键盘和鼠标的模拟" aria-hidden="true">#</a> 实现键盘和鼠标的模拟</h1><h2 id="实现" tabindex="-1"><a class="header-anchor" href="#实现" aria-hidden="true">#</a> 实现</h2><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
