import{_ as n,o as s,c as a,d as p}from"./app-35fb03de.js";const t={},o=p(`<h1 id="一些相关的示例" tabindex="-1"><a class="header-anchor" href="#一些相关的示例" aria-hidden="true">#</a> 一些相关的示例</h1><h3 id="求在100以内的所有素数-质数" tabindex="-1"><a class="header-anchor" href="#求在100以内的所有素数-质数" aria-hidden="true">#</a> 求在100以内的所有素数(质数）：</h3><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token class-name"><span class="token keyword">bool</span></span> flag <span class="token operator">=</span> <span class="token boolean">true</span><span class="token punctuation">;</span>
