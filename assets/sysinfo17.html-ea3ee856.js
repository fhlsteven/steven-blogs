import{_ as n,o as s,c as a,a as p}from"./app-a2b6e588.js";const t={},o=p(`<h1 id="得到机器上所有正在运行的进程" tabindex="-1"><a class="header-anchor" href="#得到机器上所有正在运行的进程" aria-hidden="true">#</a> 得到机器上所有正在运行的进程</h1><p><strong>实现</strong>：</p><p>Process 类 :提供对本地和远程进程的访问并使您能够启动和停止本地系统进程。</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System<span class="token punctuation">.</span>Diagnostics</span><span class="token punctuation">;</span>
