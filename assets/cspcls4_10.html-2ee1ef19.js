import{_ as n,o as s,c as a,a as p}from"./app-8e5157a8.js";const o={},t=p(`<h1 id="c-教程第十课-属性" tabindex="-1"><a class="header-anchor" href="#c-教程第十课-属性" aria-hidden="true">#</a> C＃教程第十课：属性</h1><p>（Joe Mayo　2001年06月08日 10:59）</p><p>本节课将介绍C#的属性，其目的包括：</p><ol><li>理解什么是属性</li><li>如何实现属性</li><li>创建一个只读属性</li><li>创建一个只写属性</li></ol><p>属性是C#中独具特色的新功能。通过属性来读写类中的域，这具有一定的保护功能。在其它语言中，这是通过实现特定的getter和setter方法来实现的。C#的属性具有保护功能，可以让你就象访问域一样访问属性。要了解属性的用法，我们先来看看如何用传统的方法对域进行封装。</p><p>1.清单 10-1. 传统的访问类的域的例子：Accessors.cs</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
