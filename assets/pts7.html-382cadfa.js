import{_ as e,r as t,o,c as p,b as n,d as s,e as c,a as l}from"./app-57d1f7b1.js";const i={},r={id:"windows服务开发",tabindex:"-1"},d=n("a",{class:"header-anchor",href:"#windows服务开发","aria-hidden":"true"},"#",-1),u={href:"https://www.cnblogs.com/jjstar/archive/2004/07/02/20354.html",target:"_blank",rel:"noopener noreferrer"},h=l(`<h2 id="一、安装" tabindex="-1"><a class="header-anchor" href="#一、安装" aria-hidden="true">#</a> 一、安装</h2><p>最近由于工作需要，写了一个windows服务程序，有许多经验，我会陆续写出来。</p><p>请原谅我从安装谈起，因为我一直有一个误区：只要从System.ServiceProcess.ServiceBase继承一个类并编译好就可以用.net提供的命令行程序InstallUtil.exe安装了。经过尝试，发现如果仅仅做了这样的一个类是无法用InstallUtil.exe安装的，在安装时会输出下面的信息：</p><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>D:\\&gt;installutil windowsservice2.exe
