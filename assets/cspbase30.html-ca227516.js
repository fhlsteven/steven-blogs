import{_ as t,r as p,o as e,c as o,a as n,b as s,e as c,d as l}from"./app-35fb03de.js";const u={},k={id:"如何调用只有私有构造函数的类",tabindex:"-1"},i=n("a",{class:"header-anchor",href:"#如何调用只有私有构造函数的类","aria-hidden":"true"},"#",-1),r={href:"https://www.cnblogs.com/jobs/archive/2004/07/07/22196.html",target:"_blank",rel:"noopener noreferrer"},d=l(`<p>当我试用<code>ObjectSpaces</code>时，<code>ObjectSpaces</code>竟然能够调用只有私有构造函数的类。例如：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token return-type class-name">Class</span> A
