import{_ as n,o as a,c as s,a as t}from"./app-f0851ed3.js";const o={},e=t(`<h1 id="用默认的程序打开一个文件的代码怎么写" tabindex="-1"><a class="header-anchor" href="#用默认的程序打开一个文件的代码怎么写" aria-hidden="true">#</a> 用默认的程序打开一个文件的代码怎么写？</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  用默认的程序打开一个文件的代码怎么写？
作　　者：  limengchen (lmc)  
等　　级：  ^^
信 誉 值：  100
所属论坛：  .NET技术 C#
