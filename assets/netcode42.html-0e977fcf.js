import{_ as n,o as s,c as a,a as t}from"./app-57d1f7b1.js";const p={},o=t(`<h1 id="通过tcp传送结构体" tabindex="-1"><a class="header-anchor" href="#通过tcp传送结构体" aria-hidden="true">#</a> 通过TCP传送结构体</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  通过TCP传送结构体。(我已经可能正收发包含有string,int型的结构体了，可是如果结构体中包含int[]数组，就搞不定了。)
作　　者：  roseguns (阿影)
等　　级：  ^^^
信 誉 值：  98
所属社区：  .NET技术 C#
