import{_ as n,o as s,c as a,a as p}from"./app-8e5157a8.js";const t="/steven-blogs/assets/cspcls2_4-a1d3de03.png",o={},c=p(`<h1 id="第七章-异常处理" tabindex="-1"><a class="header-anchor" href="#第七章-异常处理" aria-hidden="true">#</a> 第七章 异常处理</h1><p>通用语言运行时（CLR）具有的一个很大的优势为，异常处理是跨语言被标准化的。一个在C#中所引发的异常可以在Visual Basic客户中得到处理。不再有 HRESULTs 或者 ISupportErrorInfo 接口。</p><p>尽管跨语言异常处理的覆盖面很广，但这一章完全集中讨论C#异常处理。你稍为改变编译器的溢出处理行为，接着有趣的事情就开始了：你处理了该异常。要增加更多的手段，随后引发你所创建的异常。</p><h2 id="_7-1-校验-checked-和非校验-unchecked-语句" tabindex="-1"><a class="header-anchor" href="#_7-1-校验-checked-和非校验-unchecked-语句" aria-hidden="true">#</a> 7.1 校验(checked)和非校验(unchecked)语句</h2><p>当你执行运算时，有可能会发生计算结果超出结果变量数据类型的有效范围。这种情况被称为溢出，依据不同的编程语言，你将被以某种方式通知——或者根本就没有被通知。（C++程序员听起来熟悉吗？）</p><p>那么，C#如何处理溢出的呢？ 要找出其默认行为，请看我在这本书前面提到的阶乘的例子。（为了方便其见，前面的例子再次在清单 7.1 中给出）</p><p>清单 7.1 计算一个数的阶乘</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
