...
<span class="token keyword">protected</span> <span class="token keyword">override</span> <span class="token keyword">void</span> <span class="token operator">*</span>onResize<span class="token operator">*</span><span class="token punctuation">(</span><span class="token class-name">EventArgs</span> e<span class="token punctuation">)</span>
...
</code></pre></div><p>8、在 Debug 菜单中，点击 Start 来运行样例项目。</p><p>9、点击Button。注意观察那两个进度指示器。一个逐渐减小，另一个逐渐增加。</p>`,30),e=[o];function c(l,u){return s(),a("div",null,e)}const i=n(p,[["render",c],["__file","toolbox24.html.vue"]]);export{i as default};
