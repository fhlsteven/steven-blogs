import{_ as n,o as s,c as a,a as p}from"./app-57d1f7b1.js";const t={},o=p(`<h1 id="初探c-6" tabindex="-1"><a class="header-anchor" href="#初探c-6" aria-hidden="true">#</a> 初探c#-6</h1><p>作者： 依栏望海[17731168] 2000-10-27 15:27:30 修改 删除 [回复]</p><p>赶出一编！请指正！</p><h2 id="_1。6-统一系统类型-type-system-unification" tabindex="-1"><a class="header-anchor" href="#_1。6-统一系统类型-type-system-unification" aria-hidden="true">#</a> 1。6 统一系统类型（Type system unification）</h2><p>c#独创了一种类型——统一系统类型（为了这个累刑，我头疼死了。谁有更好的名字，请务必告诉我）。总之，所有的其他类型，包括值和引用，都可以被当作统一系统类型来对待。从概念上说，所有的类型都从它派生。这样，其他的类型就可以使用统一系统类型的属性和方法。包括一些“简单”类型，如：int。还是给个例子吧：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span> 
