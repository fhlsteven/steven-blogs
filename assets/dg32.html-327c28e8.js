import{_ as n,o as s,c as a,a as p}from"./app-f0851ed3.js";const t={},o=p(`<h1 id="c-开发windows应用程序几个小技巧" tabindex="-1"><a class="header-anchor" href="#c-开发windows应用程序几个小技巧" aria-hidden="true">#</a> c#开发windows应用程序几个小技巧</h1><p>最近，我在用.net做一个c/s的项目,把我做的情况给大家说说。</p><p>datagrid是用的c1控件的c1FlexGrid，功能很多。</p><p>自定义分组和outlook形式的列头拖拽。</p><p>textbox,combobox,checkbox是继承.net自带的控件，自己扩展的。</p><p>现在说一说碰到的几个问题，及解决方法：</p><p>1.一个应用程序只能被用户打开一次</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token class-name">Process</span> mobj_pro <span class="token operator">=</span>Process<span class="token punctuation">.</span><span class="token function">GetCurrentProcess</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>2.一个框架窗口下只打开一个子窗口</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token class-name">CustomerAdd</span> pobj_CustomerAdd<span class="token punctuation">;</span>  
...
<span class="token return-type class-name"><span class="token keyword">void</span></span> <span class="token function">OpenSheet</span><span class="token punctuation">(</span><span class="token class-name">Form</span> pobj_form<span class="token punctuation">)</span>
<span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>3.弹出式窗口显示渐变效果</p><p>在页面上添加一个timer控件fadeTimer,interval设为50</p><p>类的实例变量为</p><p><code>private m_showing=true;</code></p><p>在form_load中写：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code>Opacity <span class="token operator">=</span> <span class="token number">0.0</span><span class="token punctuation">;</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">Category</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">&quot;Data&quot;</span><span class="token punctuation">)</span></span><span class="token punctuation">,</span> <span class="token class-name">DefaultValue</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span></span><span class="token punctuation">,</span> <span class="token class-name">MergableProperty</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token boolean">false</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
    ...
    <span class="token punctuation">{</span>
        <span class="token keyword">base</span><span class="token punctuation">.</span>OnKeyPress <span class="token punctuation">(</span>e<span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>还有很多东西，正在研究中，比如发票套打在c/s中的实现，用.net读取IC卡等，等完成了再给大家共享</p><p>posted on 2004-07-23 19:23 浪漫十一狼 阅读(221) 评论(3)</p><hr><hr><p>2004-07-23 23:08 wayfarer</p><blockquote><p>不错！<br><br> 希望有更多的。</p></blockquote><p>2004-07-24 10:17 ChiKing-Lau</p><blockquote><p>我倒是很关注你的.net读取IC卡哦，尽快了，pls....</p></blockquote><p>2004-07-24 11:15 shanliangluo</p><blockquote><p>very 瓜</p></blockquote>`,30),e=[o];function c(u,l){return s(),a("div",null,e)}const i=n(t,[["render",c],["__file","dg32.html.vue"]]);export{i as default};
