import{_ as n,o as s,c as a,a as o}from"./app-d9da1b6d.js";const e={},p=o(`<h1 id="如何在windows-form中实现url-encoding-decoding" tabindex="-1"><a class="header-anchor" href="#如何在windows-form中实现url-encoding-decoding" aria-hidden="true">#</a> 如何在Windows Form中实现URL Encoding/Decoding？</h1><p>作者： 孟宪会 出自： 【孟宪会之精彩世界】 发布日期： 2003-7-24 17:32:07</p><p>如果你想在Windows Forms中实现URL Encoding，<code>HttpUtility</code>类有一个shared (static)方法实现对字符串的URL 编码。下面就是一个例子：【注意要引用System.Web】</p><div class="language-vbnet" data-ext="vbnet"><pre class="language-vbnet"><code><span class="token keyword">using</span> <span class="token keyword">System</span>.Reflection.Metadata<span class="token punctuation">;</span>
