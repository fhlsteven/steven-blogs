import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="如何通过节点的名字获取节点的index" tabindex="-1"><a class="header-anchor" href="#如何通过节点的名字获取节点的index" aria-hidden="true">#</a> 如何通过节点的名字获取节点的index</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  如何通过节点的名字获取节点的index
作　　者：  reddust (reddust)
等　　级：  ^^
信 誉 值：  60
所属论坛：  .NET技术 C#
