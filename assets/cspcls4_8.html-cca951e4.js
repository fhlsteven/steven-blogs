import{_ as n,o as s,c as a,d as t}from"./app-35fb03de.js";const p={},o=t(`<h1 id="c-教程第八课-类的继承" tabindex="-1"><a class="header-anchor" href="#c-教程第八课-类的继承" aria-hidden="true">#</a> C＃教程第八课:类的继承</h1><p>（Joe Mayo　2001年06月08日 11:05）</p><p>本节课将介绍C#中的继承，其目的如下：</p><ol><li>基类的实现</li><li>类的继承</li><li>在派生类中初始化基类</li><li>如何调用基类成员</li><li>如何覆盖基类成员</li></ol><p>继承是面向对象程序设计的主要特征之一，它可以让你重用代码，可以节省程序设计的时间。</p><p>1.清单8-1 继承： BaseClass.cs</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
