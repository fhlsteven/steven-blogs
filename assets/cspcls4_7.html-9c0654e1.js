import{_ as s,o as n,c as a,a as t}from"./app-8e5157a8.js";const p={},o=t(`<h1 id="c-教程第七课-类的入门" tabindex="-1"><a class="header-anchor" href="#c-教程第七课-类的入门" aria-hidden="true">#</a> C＃教程第七课:类的入门</h1><p>（Joe Mayo　2001年06月08日 11:10）</p><p>本节课将介绍C#中的类，其目的如下：</p><ol><li>了解构造函数的实现</li><li>了解实例和静态成员的区别</li><li>了解析构函数的使用</li><li>熟悉类的成员类型</li></ol><p>在本教程的一开始，你就已经接触到类的用法了。现在,既然已经对类有了感性认识,并知道如何定义一个类，本节课将</p><p>定义类的格式是：关键字&quot;Class&quot;后面跟着类名，类名之后的大括号中包含的是类的成员。构造函数没有返回值，且与类同名。清单7-1是一个关于类的例子。</p><p>清单 7-1. Example C# Classes: Classes.cs</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token comment">// Namespace Declaration</span>
