import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="windows-控件限制用户的基本法门-net-篇" tabindex="-1"><a class="header-anchor" href="#windows-控件限制用户的基本法门-net-篇" aria-hidden="true">#</a> Windows 控件限制用户的基本法门(.NET 篇)</h1><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token comment">/******************************************************************
