import{_ as n,o as s,c as a,a as t}from"./app-382facc7.js";const p={},o=t(`<h1 id="请教-如何通过socket传递自定义的对象" tabindex="-1"><a class="header-anchor" href="#请教-如何通过socket传递自定义的对象" aria-hidden="true">#</a> 请教:如何通过Socket传递自定义的对象?</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  请教:如何通过Socket传递自定义的对象?
作　　者：  chinayuchen (雨辰)  
等　　级：  ^
信 誉 值：  99
所属社区：  .NET技术 C#
