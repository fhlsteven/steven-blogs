import{_ as n,o as s,c as a,a as p}from"./app-f0851ed3.js";const t={},e=p(`<h1 id="初探c-12-13-14" tabindex="-1"><a class="header-anchor" href="#初探c-12-13-14" aria-hidden="true">#</a> 初探c#--12,13,14</h1><p>作者： 依栏望海[17731168] 2000-10-31 15:30:06 修改 删除 [回复]</p><h2 id="_1。12-枚举-enums" tabindex="-1"><a class="header-anchor" href="#_1。12-枚举-enums" aria-hidden="true">#</a> 1。12 枚举（Enums）</h2><p>枚举声明为一组属性相同的常量定义一个统一的类别名字。它常用于一些在编译时已知范围的常量。但这些常量的具体值要在执行时才能确定。比如，已知三原色是红蓝绿，它们同属于颜色。可以定义如下：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">enum</span> <span class="token class-name">Color</span> <span class="token punctuation">{</span> 
