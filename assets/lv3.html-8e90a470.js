import{_ as n,o as s,c as a,a as p}from"./app-d9da1b6d.js";const t={},o=p(`<h1 id="listview如何对数字排序-如何在column显示那个三角" tabindex="-1"><a class="header-anchor" href="#listview如何对数字排序-如何在column显示那个三角" aria-hidden="true">#</a> listview如何对数字排序?如何在Column显示那个三角</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  listview如何对数字进行排序? 还有 如何在Column显示那个三角?
作　　者：  bborn (五六七嗒八)
等　　级：  ^^
信 誉 值：  105
所属论坛：  .NET技术 C#
