import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="如何用c-实时获取cpu利用率" tabindex="-1"><a class="header-anchor" href="#如何用c-实时获取cpu利用率" aria-hidden="true">#</a> 如何用C＃实时获取CPU利用率</h1><blockquote><p>未知 csdn 2002-12-23</p></blockquote><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
