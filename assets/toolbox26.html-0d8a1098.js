import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="使用c-编写一个自定义控件" tabindex="-1"><a class="header-anchor" href="#使用c-编写一个自定义控件" aria-hidden="true">#</a> 使用C#编写一个自定义控件</h1><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
