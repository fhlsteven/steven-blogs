import{_ as B,o as D,c as E,a as n}from"./app-d9da1b6d.js";const A={},F=n(`<h1 id="输入验证-重启验证的软件破解" tabindex="-1"><a class="header-anchor" href="#输入验证-重启验证的软件破解" aria-hidden="true">#</a> 输入验证＋重启验证的软件破解</h1><blockquote><p>日期：2003年6月9日 作者：lordor 人气： 506</p></blockquote><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>软件名称 渗透  
版 本 2.63  
版权所有 软件发行商  
