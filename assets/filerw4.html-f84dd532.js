import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="对文本文件进行读写操作" tabindex="-1"><a class="header-anchor" href="#对文本文件进行读写操作" aria-hidden="true">#</a> 对文本文件进行读写操作</h1><h2 id="对文本文件进行读操作" tabindex="-1"><a class="header-anchor" href="#对文本文件进行读操作" aria-hidden="true">#</a> 对文本文件进行读操作</h2><blockquote><p>源作者：追风 人气：3486</p></blockquote><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
