...
<span class="token punctuation">{</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">Close</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre></div><p>4．到此为止，我们已经完成了所有的代码编写工作。现在可以按Ctrl＋F5试试运行效果了。首先会出现下面的主窗体：</p><p><img src="`+k+'" alt="img_7"></p><p>按下&quot;浏览目录选择对话框&quot;按钮后就出现下面的目录选择对话框了：</p><p><img src="'+i+'" alt="img_8"></p><p>在目录选择对话框上选定一个目录后，我们按&quot;选择&quot;按钮。这样我们又回到了程序的主界面。因为该主界面是用来显示所选择的目录的一些相关信息的，其中包括了：完整路径、路径信息中的创建时间、全名、上次访问时间、上次改写时间等。图示如下：</p><p><img src="'+r+`" alt="img_9"></p><p>这样，我们就完成了程序的测试工作了。当然这样的范例是还没有实用功能的，不过你可以试着用同样的方法开发出一个合适的目录选择对话框运用到自己的应用程序中，甚至是一个目录选择对话框组件以供后来者使用，让更多的人受益于你的成果。这样其效用就完全不同了，作为作者的我也会感到相当欣慰的。</p><h2 id="三、总结" tabindex="-1"><a class="header-anchor" href="#三、总结" aria-hidden="true">#</a> 三、总结</h2><p>现在这个程序虽然只具有一般的目录选择功能，不过做完这个程序，我们不难发现用C#完成一些应用程序是非常方便的。相比以前我们在SDK、MFC下完成这些还要写很多东西，工作量是非常大而且复杂的。现在微软为我们做好了许多此类工作，我们何不乐意接受呢？所以，快加入C#的行列吧。</p><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>Powered by DvNews.net
来源：网络
阅读：338 次
日期：2003-6-18
</code></pre></div>`,33),g=[m];function w(y,A){return s(),a("div",null,g)}const h=n(d,[["render",w],["__file","folder10.html.vue"]]);export{h as default};
