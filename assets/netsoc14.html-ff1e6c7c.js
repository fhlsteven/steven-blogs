import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="socket基本编程" tabindex="-1"><a class="header-anchor" href="#socket基本编程" aria-hidden="true">#</a> Socket基本编程</h1><p>两台机器的聊天程序!服务端打开,准备接受客户端数据,然后在另外一台机器上运行客户端,输入服务端IP,端口,就可以聊天了.</p><p>===Client客户端===</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
