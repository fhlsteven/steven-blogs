import{_ as n,o as s,c as a,a as t}from"./app-a2b6e588.js";const o={},p=t(`<h1 id="如何在datagrid某列中加入combobox控件" tabindex="-1"><a class="header-anchor" href="#如何在datagrid某列中加入combobox控件" aria-hidden="true">#</a> 如何在DataGrid某列中加入ComboBox控件</h1><p>１．建立一个标准的Windows应用程序．</p><p>２．向窗体中加入一个DataGrid控件．</p><p>３．在申明段前加入如下代码：</p><div class="language-vb" data-ext="vb"><pre class="language-vb"><code><span class="token keyword">Imports</span> System<span class="token punctuation">.</span>Data<span class="token punctuation">.</span>SqlClient
