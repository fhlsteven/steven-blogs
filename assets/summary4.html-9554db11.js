import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},e=t(`<h1 id="几个c-编程的小技巧" tabindex="-1"><a class="header-anchor" href="#几个c-编程的小技巧" aria-hidden="true">#</a> 几个C#编程的小技巧</h1><h2 id="几个c-编程的小技巧-一" tabindex="-1"><a class="header-anchor" href="#几个c-编程的小技巧-一" aria-hidden="true">#</a> 几个C#编程的小技巧 (一)</h2><blockquote><p>作者：wyhw 发表时间：2003-5-11 推荐程度： ★ 查看作者信息以及作者文集</p></blockquote><h3 id="一、最小化窗口" tabindex="-1"><a class="header-anchor" href="#一、最小化窗口" aria-hidden="true">#</a> 一、最小化窗口</h3><p>点击“X”或“Alt+F4”时，最小化窗口，如：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">protected</span> <span class="token keyword">override</span> <span class="token return-type class-name"><span class="token keyword">void</span></span> <span class="token function">WndProc</span><span class="token punctuation">(</span><span class="token keyword">ref</span> <span class="token class-name">Message</span> m<span class="token punctuation">)</span>
