import{_ as n,o as a,c as s,a as t}from"./app-a2b6e588.js";const p={},o=t(`<h1 id="how-to-使用-visual-c-net-对-datagrid-windows-控件执行分页" tabindex="-1"><a class="header-anchor" href="#how-to-使用-visual-c-net-对-datagrid-windows-控件执行分页" aria-hidden="true">#</a> HOW TO：使用 Visual C# .NET 对 DataGrid Windows 控件执行分页</h1><p>适用于<br> 本文的发布号曾为 CHS307710<br> 有关本文的 Microsoft Visual Basic .NET 版本，请参见 305271。<br> 有关本文的 Microsoft Visual J# .NET 版本，请参见 CHS320626。</p><p>本文引用下面的 Microsoft .NET 框架类库名称空间：</p><ul><li>System</li><li>System.Data</li><li>System.Data.SqlClient</li></ul><h2 id="本任务的内容" tabindex="-1"><a class="header-anchor" href="#本任务的内容" aria-hidden="true">#</a> 本任务的内容</h2><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>概要
    要求
