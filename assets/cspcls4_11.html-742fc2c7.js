import{_ as n,o as s,c as a,a as p}from"./app-57d1f7b1.js";const t={},o=p(`<h1 id="c-教程第十一课-索引指示器" tabindex="-1"><a class="header-anchor" href="#c-教程第十一课-索引指示器" aria-hidden="true">#</a> C＃教程第十一课:索引指示器</h1><p>（Joe Mayo　2001年06月08日 10:38）</p><p>本节课将介绍C#的索引指示器，其目的包括：</p><ol><li>了解什么是索引指示器</li><li>如何实现索引指示器</li><li>重载索引指示器</li><li>了解如何实现多参数的索引指示器</li></ol><p>索引指示器并不难使用。它们的用法跟数组相同。在一个类内部，你可以按照你的意愿来管理一组数据的集合。这些对象可以是类成员的有限集合，也可以是另外一个数组，或者是一些复杂的数据结构。不考虑类的内部实现，其数据可以通过使用索引指示器来获得。如下是一个例子：</p><p>1.清单 11-1. 索引指示器的例子：IntIndexer.cs</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
