import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="怎么读取文本文件" tabindex="-1"><a class="header-anchor" href="#怎么读取文本文件" aria-hidden="true">#</a> 怎么读取文本文件</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  怎么读取文本文件？
