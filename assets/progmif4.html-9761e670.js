import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="在c-net-中建立一个平滑的进度条" tabindex="-1"><a class="header-anchor" href="#在c-net-中建立一个平滑的进度条" aria-hidden="true">#</a> 在C# .NET 中建立一个平滑的进度条</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>本文内容
概述
建立一个自定义的进度条控件
建立一个简单的客户端应用
