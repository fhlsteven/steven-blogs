import{_ as s,o as n,c as a,a as e}from"./app-477de5b2.js";const p={},t=e(`<h1 id="c-中结构与类的区别" tabindex="-1"><a class="header-anchor" href="#c-中结构与类的区别" aria-hidden="true">#</a> c#中结构与类的区别</h1><p>目录</p><ul><li>类与结构的实例比较</li><li>类与结构的差别</li><li>如何选择结构还是类</li></ul><h2 id="一-类与结构的示例比较" tabindex="-1"><a class="header-anchor" href="#一-类与结构的示例比较" aria-hidden="true">#</a> 一．类与结构的示例比较</h2><p>结构示例：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">public</span> <span class="token keyword">struct</span> <span class="token class-name">Person</span>
