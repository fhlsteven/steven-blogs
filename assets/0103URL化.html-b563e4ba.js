import{_ as r,r as a,o as i,c as o,b as e,d as n,e as s,a as c}from"./app-a2b6e588.js";const l={},d=e("h1",{id:"面试题-01-03-url化",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#面试题-01-03-url化","aria-hidden":"true"},"#"),n(" 面试题 01.03. URL化")],-1),u={id:"面试题-01-03-url化-简单",tabindex:"-1"},g=e("a",{class:"header-anchor",href:"#面试题-01-03-url化-简单","aria-hidden":"true"},"#",-1),h={href:"https://leetcode-cn.com/problems/string-to-url-lcci/",target:"_blank",rel:"noopener noreferrer"},p=e("strong",null,"简单",-1),_=c(`<p>URL化。编写一种方法，将字符串中的空格全部替换为%20。假定该字符串尾部有<strong>足够的空间</strong>存放<strong>新增字符</strong>，并且知道字符串的“真实”长度。（注：用Java实现的话，请使用字符数组实现，以便直接在数组上操作。）</p><p>示例 1：</p><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>输入：&quot;Mr John Smith    &quot;, 13
...
</code></pre></div>`,14);function x(S,q){const t=a("ExternalLinkIcon");return i(),o("div",null,[d,e("h2",u,[g,n(),e("a",h,[n("面试题 01.03. URL化"),s(t)]),n(),p]),_])}const v=r(l,[["render",x],["__file","0103URL化.html.vue"]]);export{v as default};
