import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="为combobox控件添加图片" tabindex="-1"><a class="header-anchor" href="#为combobox控件添加图片" aria-hidden="true">#</a> 为ComboBox控件添加图片</h1><p>扩展类 ComboBoxEx.cs</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
