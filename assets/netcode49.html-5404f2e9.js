import{_ as t,r as p,o,c as e,b as n,d as s,e as c,a as u}from"./app-382facc7.js";const l="/steven-blogs/assets/netcode49_1-6ae7915a.png",k={},i={id:"基于不可靠数据报的文件传输",tabindex:"-1"},r=n("a",{class:"header-anchor",href:"#基于不可靠数据报的文件传输","aria-hidden":"true"},"#",-1),d={href:"https://www.cnblogs.com/thomas/archive/2005/01/30/99427.html",target:"_blank",rel:"noopener noreferrer"},m=u(`<div class="language-txt" data-ext="txt"><pre class="language-txt"><code>目录:
    引言
    数据报格式
    协议
    实现
