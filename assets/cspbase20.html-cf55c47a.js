import{_ as n,o as s,c as a,a as o}from"./app-8e5157a8.js";const t={},p=o(`<h1 id="console输出彩色字体-源码" tabindex="-1"><a class="header-anchor" href="#console输出彩色字体-源码" aria-hidden="true">#</a> Console输出彩色字体(源码)</h1><p>先是<code>consolecolour.cs</code>类，用来调用颜色</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token comment">// ConsoleColour.cs </span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">{</span>
        ...
        <span class="token keyword">private</span> <span class="token function">ConsoleColour</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
        ...
        <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token return-type class-name"><span class="token keyword">bool</span></span> <span class="token function">SetForeGroundColour</span><span class="token punctuation">(</span>
          <span class="token class-name">ForeGroundColour</span> foreGroundColour<span class="token punctuation">)</span>
        <span class="token punctuation">{</span>
        ...
        <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token return-type class-name"><span class="token keyword">bool</span></span> <span class="token function">SetForeGroundColour</span><span class="token punctuation">(</span>
          <span class="token class-name">ForeGroundColour</span> foreGroundColour<span class="token punctuation">,</span>
          <span class="token class-name"><span class="token keyword">bool</span></span> brightColours<span class="token punctuation">)</span>
        <span class="token punctuation">{</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">{</span>
            ConsoleColour<span class="token punctuation">.</span><span class="token function">SetForeGroundColour</span><span class="token punctuation">(</span>ConsoleColour<span class="token punctuation">.</span>ForeGroundColour<span class="token punctuation">.</span>Green<span class="token punctuation">)</span><span class="token punctuation">;</span>
            ...
            ConsoleColour<span class="token punctuation">.</span><span class="token function">SetForeGroundColour</span><span class="token punctuation">(</span>ConsoleColour<span class="token punctuation">.</span>ForeGroundColour<span class="token punctuation">.</span>Red<span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>分别存成<code>ConsoleColour.cs</code>和<code>Console.cs</code>,然后提示符下编译</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>CSC /t:library　ConsoleColour.cs 
CSC /r:ConsoleColour.dll　Console.cs 
</code></pre></div><p>生成console.exe可执行文件 执行后看看效果吧！</p>`,8),e=[p];function c(l,u){return s(),a("div",null,e)}const r=n(t,[["render",c],["__file","cspbase20.html.vue"]]);export{r as default};
