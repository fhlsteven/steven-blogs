import{_ as n,o as s,c as a,a as t}from"./app-a2b6e588.js";const p={},o=t(`<h1 id="异步socket通信总结" tabindex="-1"><a class="header-anchor" href="#异步socket通信总结" aria-hidden="true">#</a> 异步Socket通信总结</h1><h2 id="服务端-异步" tabindex="-1"><a class="header-anchor" href="#服务端-异步" aria-hidden="true">#</a> 服务端(异步)</h2><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System<span class="token punctuation">.</span>Net</span><span class="token punctuation">;</span>
