import{_ as s,o as n,c as a,a as p}from"./app-f0851ed3.js";const e={},t=p(`<h1 id="如何引用另一个文件中定义的类" tabindex="-1"><a class="header-anchor" href="#如何引用另一个文件中定义的类" aria-hidden="true">#</a> 如何引用另一个文件中定义的类</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  如何引用另一个文件中定义的类
