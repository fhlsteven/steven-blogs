import{_ as p,r as t,o,c as e,b as n,d as s,e as c,a as l}from"./app-477de5b2.js";const u={},k={id:"在-c-中处理结构内的数组",tabindex:"-1"},i=n("a",{class:"header-anchor",href:"#在-c-中处理结构内的数组","aria-hidden":"true"},"#",-1),r={href:"https://www.cnblogs.com/flier/archive/2004/08/14/33245.html",target:"_blank",rel:"noopener noreferrer"},d=l(`<p>Posted on 2004-08-14 01:04 Flier Lu 阅读(6744) 评论(6)</p><p>原文：<code>http://www.blogcn.com/User8/flier_lu/index.html?id=3318394</code></p><p>在 C/C++ 代码中，大量掺杂着包括普通类型和数组的结构，如定义 PE 文件头结构的 IMAGE_OPTIONAL_HEADER 结构定义如下：</p><div class="language-cpp" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token class-name">_IMAGE_DATA_DIRECTORY</span>
