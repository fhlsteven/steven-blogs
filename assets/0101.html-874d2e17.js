import{_ as a,r as l,o as i,c as s,b as t,d as n,e as o,a as r}from"./app-f0851ed3.js";const c={},u=t("h1",{id:"面试题-01-01-判定字符是否唯一",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#面试题-01-01-判定字符是否唯一","aria-hidden":"true"},"#"),n(" 面试题 01.01. 判定字符是否唯一")],-1),d={id:"题目-面试题-01-01-判定字符是否唯一",tabindex:"-1"},g=t("a",{class:"header-anchor",href:"#题目-面试题-01-01-判定字符是否唯一","aria-hidden":"true"},"#",-1),p={href:"https://leetcode-cn.com/problems/is-unique-lcci/",target:"_blank",rel:"noopener noreferrer"},h={href:"https://leetcode-cn.com/problems/is-unique-lcci/",target:"_blank",rel:"noopener noreferrer"},q=t("strong",null,"简单",-1),C=r(`<p>要求：实现一个算法，确定一个字符串 s 的所有字符是否全都不同。</p><p>示例 1：</p><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>输入: s = &quot;leetcode&quot;
输出: false 
