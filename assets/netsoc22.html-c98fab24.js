import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="c-的socket收发数据过程中-如何判断连接断开、收发方主动终止、发送错误、接收错误等状态" tabindex="-1"><a class="header-anchor" href="#c-的socket收发数据过程中-如何判断连接断开、收发方主动终止、发送错误、接收错误等状态" aria-hidden="true">#</a> C#的socket收发数据过程中，如何判断连接断开、收发方主动终止、发送错误、接收错误等状态</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  C#的socket收发数据过程中，如何判断连接断开、收发方主动终止、发送错误、接收错误等状态
作　　者：  cq_lqj (程序员秘书)
等　　级：  ^
信 誉 值：  100
所属社区：  .NET技术 C#
