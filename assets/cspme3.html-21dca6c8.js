import{_ as e,o as t,c,a as o}from"./app-d9da1b6d.js";const n={},r=o(`<h1 id="如何用代码给一个控件添加新的事件" tabindex="-1"><a class="header-anchor" href="#如何用代码给一个控件添加新的事件" aria-hidden="true">#</a> 如何用代码给一个控件添加新的事件</h1><div class="language-txt" data-ext="txt"><pre class="language-txt"><code>主　　题：  如何用代码给一个控件添加新的事件
作　　者：  limengchen (lmc)  
等　　级：
信 誉 值：  100
所属论坛：  .NET技术 C#
