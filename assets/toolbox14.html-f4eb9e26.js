import{_ as n,o as s,c as a,a as t}from"./app-f0851ed3.js";const p={},o=t(`<h1 id="装载外部dll全攻略" tabindex="-1"><a class="header-anchor" href="#装载外部dll全攻略" aria-hidden="true">#</a> 装载外部DLL全攻略</h1><blockquote><p>ArLi2003（原作） 关键字 装载外部DLL,Assembly,Type,反射,装配件</p></blockquote><p>例DLL 文件内容如下：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
