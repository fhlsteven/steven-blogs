import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="只运行单一实例" tabindex="-1"><a class="header-anchor" href="#只运行单一实例" aria-hidden="true">#</a> 只运行单一实例</h1><p>方法1：</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System<span class="token punctuation">.</span>Threading</span><span class="token punctuation">;</span>
