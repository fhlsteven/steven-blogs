import{_ as n,o as s,c as a,a as p}from"./app-f0851ed3.js";const t={},o=p(`<h1 id="c-中实现改变显示器的分辨率-原码" tabindex="-1"><a class="header-anchor" href="#c-中实现改变显示器的分辨率-原码" aria-hidden="true">#</a> C#中实现改变显示器的分辨率(原码)</h1><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
