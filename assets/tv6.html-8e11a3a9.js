import{_ as n,o as s,c as a,a as t}from"./app-d9da1b6d.js";const p={},o=t(`<h1 id="将treeview存储、写入数据库的扩展类treeviewex" tabindex="-1"><a class="header-anchor" href="#将treeview存储、写入数据库的扩展类treeviewex" aria-hidden="true">#</a> 将TreeView存储、写入数据库的扩展类TreeViewEx</h1><p>在一个项目中用到了读取、生成并保存TreeView内容到数据库的应用，经过研究，并着重参考了planet-source-code上的一篇文章<code>&lt;TreeView Interface (Drag and Drop; Add, Rename, and Delete Nodes; Save Tree to Database)&gt;</code>，将原文的VB.NET代码改造成了C#代码，与大家共同分享。</p><div class="language-csharp" data-ext="cs"><pre class="language-csharp"><code>
